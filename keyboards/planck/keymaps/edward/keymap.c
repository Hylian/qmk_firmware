...
[_QWERTY] = {
  ...
  {KC_MINS, KC_EQL,  KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_BSPC, RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},
 ...
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |  F7  |  F8  |  F9  |  F10 |  F11 |  F12 |ISO ~ |ISO | |Mouse1|Mouse2|      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_LOWER] = {
  ...
  {_______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  S(KC_NUHS), S(KC_NUBS), KC_BTN1, KC_BTN2,  _______},
  {_______, _______, _______, _______, _______, KC_ENT,  KC_DEL,  _______,    KC_MS_L,    KC_MS_D, KC_MS_U, KC_MS_R}
},
...
[_RAISE] = {
  ...
  {_______, _______, _______, _______, _______, KC_ENT, KC_DEL, _______,  KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY}
},
